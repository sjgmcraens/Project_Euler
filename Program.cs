    ...
    class Program
    {
        ...
        // This class contains the information pertaining to the all the problems.
        {
            ...
            static Problems() // This is the constructor: below, we fill 'P' and add methods for returning the solution to the problems.
            {
                ...
                P.Add(12, new Problem("Highly divisible triangular number",
            ...
            public static string Sol_3()
            {
                ...
                List<int> factors = Prime.GetPrimeFactors(numToFactor, Prime.GetPrimesUpToN(600851475143));
            ...
            public static string Sol_10()
            {
                ...
                // Return
                return $"Answer: {Prime.GetPrimesUpToN(limit - 1).Sum()}";
            }
            ...
            public static string Sol_12()
            {
                ...
                for (int n = 1; true; n++)
                {
                    ...
                    if (divAm > 500)
                    {
                        return $"Found triangular number #{n}: {t} with divisors: {GetDivisors(t)}";
                    }
                }
            }
            ...
            // This class contains a list of the known primes and related methods.
        {
            ...
            public static int largestChecked;
            ...
            public static Dictionary<int,int> GetPrimeFactors(int n)
            {
                ...
                CalcPrimes_UpToAndInc_N((int)Math.Sqrt(n));
                ...
                while (factorFound)
                {
                    ...
                    // Else look for factor and divide n by it
                    factorFound = false;
                    for (int pI=0; true; pI++)
                    {
                        if (n % p == 0) // if divisor
                        {
            ...
            public static void CalcPrimes_UpToAndInc_N(long n)
            {
                ...
                foreach (int P in Primes)
                {
                    ...
                    {
                        // Sieve
                        sieve.Insert(M, false);
                    }
                }

                // Check all prime candidates (largestChecked < P <= sqrtN)
                for (int P = largestChecked+1; P <= sqrtN; P++)
                {
                    if (sieve[P]) // If not sieved (prime)
                    {
                        Primes.Add(P);
        ...
        public static Dictionary<int, HashSet<int>> divisorsOfN = new Dictionary<int, HashSet<int>>()
        {
            { 1, new HashSet<int>(){ 1 } },
            { 2, new HashSet<int>(){ 1,2 } }
        };
        public static List<int> GetDivisors(int n)
        {

            // Create new list
            divisorsOfN[n] = new HashSet<int>() { 1, n};

            // Get prime factors
            int[] primeFactors = Prime.GetPrimeFactors(n);

            // Add all combinations of the prime factors to the divisors
            ...
            {
                // Get Prime
                int P = (int) Prime.GetPrimeAtIndex(pI);

                //Console.WriteLine($"Trying P: {P}.");

                // Return if ran out of Primes to check
                if (P > n / 2)
                {
                    //Console.WriteLine($"Returning.");
                    return divisorsOfN[n];
                }
                ...
                if (n % P == 0)
                {
                    ...
                    // Add P and R's divisors
                    if (!divisorsOfN[n].Contains(P))
                    {
                        divisorsOfN[n].UnionWith(GetDivisors(P));
                    }
                    if (!divisorsOfN[n].Contains(R))
                    {
                        divisorsOfN[n].UnionWith(GetDivisors(R));
                    }
                }
            }
        }
        ...
        public static int GetNumOfDivisors(int n)
        {
            ...
            foreach (int primeExp in Prime.GetPrimeFactorExponents(n).Values)
            {
                divAm *= (primeExp + 1);
            }
            return divAm;
